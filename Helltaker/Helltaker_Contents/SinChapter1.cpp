...
void SinChapter1::Phase1Start()
{
	...
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 6, 6);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 5, 7);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 4, 8);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 3, 9);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 2, 10);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 0, 12);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 2, 13);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 4, 14);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 1, 15);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 6, 15);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 0, 16);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 3, 16);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 2, 17);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 5, 17);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 4, 18);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 6, 19);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 3, 21);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 0, 22);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 6, 22);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 2, 23);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 4, 23);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 1, 24);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 5, 24);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 0, 25);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 3, 25);
	M_CreateSmallChain(ESinSmallChainType::Hor, 1, 6, 25);
}
