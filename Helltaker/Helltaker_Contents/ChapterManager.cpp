...
// ¸ÊÁÂÇ¥¸¦ À©µµ¿ì À§Ä¡·Î º¯È¯ÇÏ´Â ÇÔ¼ö
...
void ChapterManager::C_SpawnDialogue(std::string_view _Name)
{
	FVector WinScale = ContentsHelper::GetWindowScale();
...
void ChapterManager::C_SpawnMenubar()
{
	float interval = 0.0f;
	FVector WinScale = ContentsHelper::GetWindowScale();
...
void ChapterManager::C_SetFocusMenuIndex(int _Index)
{
...
void ChapterManager::C_SelectMenuBar()
{
